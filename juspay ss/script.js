...
function waitAndResponce(inputText) {
    ...
    switch (inputText.toLowerCase().trim()) {
        case "intro":
            setTimeout(() => {
                sendTextMessage("Hello there 👋🏻,<br><br>We are  <span class='bold'><a class='alink'>Code Poltergeists</a>.</span><span><br><br>Please share your current location / origin location.<br><br>Send <span class='bold'>'help'</span> to know more about me.<br>");
            }, 2000);
            break;
        case "help":
            sendTextMessage("<span class='sk'>Send Keyword to get what you want to know about me...<br>e.g<br><span class='bold'>'From'</span> - to choose Location <br><span class='bold'>'to'</span> - enter destinaton <br><span class='bold'>'Fare Compare'</span> - to get details<br><span class='bold'>'address'</span> - to get Driver address<br><span class='bold'>'contact'</span> - to get ways to connect with Driver<br><span class='bold'>'feedback'</span> - <br><span class='bold'>'clear'</span> - to clear conversation<br><span class='bold'>'about'</span> - to know about this site</span>");
            break;
        case "ride":
